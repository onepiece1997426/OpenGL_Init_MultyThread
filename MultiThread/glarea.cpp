...
//-----
void GLArea::ChangeMesh()
{
    int err=vcg::tri::io::ImporterPLY<CMesh>::Open(mesh,"/media/yangxuyuan/Planetarian/UAV_3DReconstruction/Samples/xs/TestMesh/lossCorner/gdLidar.ply");
     if(err!=0){
       const char* errmsg=vcg::tri::io::ImporterPLY<CMesh>::ErrorMsg(err);
           QMessageBox::warning(this,tr("Error Loading Mesh"),QString(errmsg));
     }
     ...
     glWrap.Update();
     //updateGL();
     emit setStatusBar("asdasdasdasd");
     emit MyUpdateUI();
}
